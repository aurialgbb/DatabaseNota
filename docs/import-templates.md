...
CV: template cabang memakai Tindakan, ID Cabang, Nama Cabang, Nama CV, Tipe Cabang. Mandiri wajib CV; satu CV boleh dipakai beberapa cabang. CK hanya pooling dan harus tanpa CV. Ubah dengan CV kosong mempertahankan nilai lama; perubahan menjadi CK mengosongkan CV. Preview dan penyimpanan bulk memakai branches.data.cv. File lama tetap terbaca, tetapi tambah Mandiri tanpa CV ditolak. Validasi: 21 tes lulus, termasuk aturan CV dan pemisahan CK.
